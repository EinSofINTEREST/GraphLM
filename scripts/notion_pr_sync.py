...
DEFAULT_DS_ID = "9d5313fe-bef5-4a91-8787-3ca443f42997"
DEFAULT_REPO = "EinSofINTEREST/GraphLM"
...
def upsert_pr(ds_id: str, pr: dict, body_sync: bool = True) -> str:
    ...
    if existing:
        ...
        notion_request(f"/pages/{existing}", "PATCH", {"properties": props, "in_trash": False})
        page_id = existing
        verb = "updated"
    else:
        res = notion_request(
